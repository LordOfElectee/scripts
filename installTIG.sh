...
function installInfluxDB {
    ...
    wget https://dl.influxdata.com/influxdb/releases/influxdb_1.8.10_amd64.deb && dpkg --force-all -i influxdb_1.8.10_amd64.deb
...
function installTelegraf {
    ...
    wget https://dl.influxdata.com/telegraf/releases/telegraf_1.20.3-1_amd64.deb && dpkg --force-all -i telegraf_1.20.3-1_amd64.deb
